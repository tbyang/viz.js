...
### Viz(src, options={ format="svg", engine="dot", scale, images=[{ href, width, height }], totalMemory=16777216 })
...
For example:
    ...
    result = Viz("digraph { a[image=\"test.png\"]; }", { images: [ { href: "test.png", width: "400px", height: "300px" } ] });
